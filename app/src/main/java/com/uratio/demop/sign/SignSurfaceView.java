...
import com.uratio.demop.wave.voice.WaveSurfaceView;
 ...
 * 签名控件
 */
public class SignSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public SignSurfaceView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
