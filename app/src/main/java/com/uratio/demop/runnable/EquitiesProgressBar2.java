...
public class EquitiesProgressBar2 extends View {
    ...
    public static final int DEFAULT_TEXT_COLOR = 0xFF8B672D;
    ...
    private Paint mPaintLeftCircle = new Paint(Paint.ANTI_ALIAS_FLAG);
    ...
    public EquitiesProgressBar2(Context context) {
        super(context);
        init(context, null);
    }

    public EquitiesProgressBar2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EquitiesProgressBar2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        canvas.drawText("第一个", 0,50-(rectText.top+rectText.bottom)/2,mTextPaint);
         ...
         * 左侧圆角矩形
         */
        mPaintLeftCircle.setColor(progressTextBgColor);
        mPaintLeftCircle.setStyle(Paint.Style.FILL);
        mPathLeft.addRoundRect(space,top-radius,headerWidth+space,top+radius, radius, radius, Path.Direction.CW);
        canvas.drawPath(mPathLeft,mPaintLeftCircle);
        ...
        canvas.drawRect(headerWidth-cutWidth+progress*one,top-progressHeight/2,width-headerWidth+cutWidth,top+progressHeight/2,mPaint);
        ...
        if (progress == max) {
             ...
             */
            mPaint.setColor(progressTextColor);
            mTextPaint.setColor(progressTextBgColor);
        }
        //绘制右侧圆角矩形
        mPaint.setStyle(Paint.Style.FILL);
        mPathRight.addRoundRect(width-headerWidth-space,top-radius,width-space,top+radius, radius, radius, Path.Direction.CW);
         ...
         * 进度连接线
         */
        mLinePaint.setColor(progressTextBgColor);
