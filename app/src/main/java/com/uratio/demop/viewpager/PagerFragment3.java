...
public class PagerFragment3 extends Fragment {
    ...
    public static PagerFragment3 newInstance(int index) {
        PagerFragment3 fragment = new PagerFragment3();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        switch (index) {
            ...
            case 3:
                ...
                break;
            case 4:
                view.setBackgroundColor(Color.parseColor("#20F00FFF"));
                break;
        }

        CustomRcv recyclerView = view.findViewById(R.id.recyclerView);
