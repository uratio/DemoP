...
public class WavePointView3 extends View {
    private static final String TAG = WavePointView3.class.getSimpleName();
    ...
    // xml布局构造方法
    public WavePointView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
