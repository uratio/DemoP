 ...
 */
public class SwipeLayoutAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private LayoutInflater inflater;
    private Context mContext;
    private IonSlidingViewClickListener mIDeleteBtnClickListener;
    private List<Account> list;

    public SwipeLayoutAdapter(Context context, List<Account> list) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_swipelayout, parent, false);
...
//            ((SlidingButtonView) itemView).setSlidingButtonListener(SwipeLayoutAdapter.this);
        }
    }
}