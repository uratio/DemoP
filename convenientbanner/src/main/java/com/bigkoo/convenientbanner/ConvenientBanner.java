...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        // disable custom viewpager scroll
//        initViewPagerScroll();
    }
    ...
    public ConvenientBanner setPages(CBViewHolderCreator holderCreator,List<T> datas){
        ...
        if (page_indicatorId != null)
            setPageIndicator(page_indicatorId,5, 0, 5, 0);
        return this;
    }
     ...
     */
    public ConvenientBanner setPageIndicator(int[] page_indicatorId,int left,int top,int right,int bottom) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(left,top,right,bottom);
     ...
     * @return
     */
    public ConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align,int bottom) {
